...
import com.huiyee.pay.util.httpClient.HttpProtocolHandler;
import com.huiyee.pay.util.httpClient.HttpRequest;
import com.huiyee.pay.util.httpClient.HttpResponse;
import com.huiyee.pay.util.httpClient.HttpResultType;
import com.huiyee.pay.sign.MD5;
import com.huiyee.pay.sign.RSA;

/* *
 *类名：AlipaySubmit4phone
 *功能：支付宝各接口请求提交类
...
public class AlipaySubmit4phone {
	...
	public static String buildRequestMysign(Map<String, String> sPara) {
    	String prestr = AlipayCore4phone.createLinkString(sPara); //把数组所有元素，按照“参数=参数值”的模式用“&”字符拼接成字符串
    	String mysign = "";
        if(AlipayConfig4Phone.sign_type.equals("MD5") ) {
        	mysign = MD5.sign(prestr, HyConfig.alikey, AlipayConfig4Phone.input_charset);
        }
        if(AlipayConfig4Phone.sign_type.equals("0001") ){
        	mysign = RSA.sign(prestr, AlipayConfig4Phone.private_key, AlipayConfig4Phone.input_charset);
        }
        return mysign;
    }
    ...
    private static Map<String, String> buildRequestPara(Map<String, String> sParaTemp) {
        //除去数组中的空值和签名参数
        Map<String, String> sPara = AlipayCore4phone.paraFilter(sParaTemp);
        //生成签名结果
        ...
        if(! sPara.get("service").equals("alipay.wap.trade.create.direct") && ! sPara.get("service").equals("alipay.wap.auth.authAndExecute")) {
        	sPara.put("sign_type", AlipayConfig4Phone.sign_type);
        }
    ...
    public static String buildRequest(String ALIPAY_GATEWAY_NEW, Map<String, String> sParaTemp, String strMethod, String strButtonName) {
        ...
        sbHtml.append("<form id=\"alipaysubmit\" name=\"alipaysubmit\" action=\"" + ALIPAY_GATEWAY_NEW
                      + "_input_charset=" + AlipayConfig4Phone.input_charset + "\" method=\"" + strMethod
                      + "\">");
    ...
    public static String buildRequest(String ALIPAY_GATEWAY_NEW, String strParaFileName, String strFilePath,Map<String, String> sParaTemp) throws Exception {
        ...
        //设置编码集
        request.setCharset(AlipayConfig4Phone.input_charset);

        request.setParameters(generatNameValuePair(sPara));
        request.setUrl(ALIPAY_GATEWAY_NEW+"_input_charset="+AlipayConfig4Phone.input_charset);
    ...
    public static String getRequestToken(String text) throws Exception {
    	...
    	if (paraText.get("res_data") != null) {
    		...
    		if(AlipayConfig4Phone.sign_type.equals("0001")) {
    			res_data = RSA.decrypt(res_data, AlipayConfig4Phone.private_key, AlipayConfig4Phone.input_charset);
    		}
	...
	public static String query_timestamp() throws MalformedURLException,
        ...
        String strUrl = "https://mapi.alipay.com/gateway.do?service=query_timestamp&partner=" + HyConfig.alipartner;
