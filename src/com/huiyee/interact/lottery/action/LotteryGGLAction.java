...
public class LotteryGGLAction extends InteractModelAction
{
	...
	public String execute() throws Exception
	{
		...
		dto = (LotteryDto) lotteryMgr.findAllLottery(pageId, ownerid, "G",IPageConstants.OWNER_INTERACT_SHOW);
		return SUCCESS;
	}
