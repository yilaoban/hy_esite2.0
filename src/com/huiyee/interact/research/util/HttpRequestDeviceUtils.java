package com.huiyee.interact.research.util;
...
public class HttpRequestDeviceUtils
{
	...
	{ "Windows 98", "Windows ME", "Windows 2000", "Windows XP", "Windows NT", "Ubuntu" ,"macos"};
	/** 手机浏览器的User-Agent里的关键词 */
	private static String[] mobileUserAgents = new String[]
	{ "Nokia",// 诺基亚，有山寨机也写这个的，总还算是手机，Mozilla/5.0 (Nokia5800 XpressMusic)UC
	 ...
	 */
	public static String getMediaDevice(String userAgent)
	{
