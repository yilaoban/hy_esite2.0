...
import com.huiyee.esite.dto.Feature156Dto;
...
public class Feature156ManagerImpl extends AbstractFeatureManager{
	...
	public IDto config(long fid, Account account) {
		Feature156Dto dto = new Feature156Dto();
		...
		List<ContentCategory> list=hd154Dao.findCategory(account.getOwner().getId(),IPageConstants.CONTENT_NEW);
	...
	public String configSub(long featureid, IDto dto, Account account) {
		Feature156Dto d = (Feature156Dto)dto;
	    try
		{
