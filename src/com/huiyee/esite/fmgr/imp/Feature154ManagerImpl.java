...
import com.huiyee.esite.dto.Feature154Dto;
...
public class Feature154ManagerImpl extends AbstractFeatureManager{
	...
	public IDto config(long fid, Account account) {
		Feature154Dto dto = new Feature154Dto();
		...
		List<ContentCategory> list=hd154Dao.findCategory(account.getOwner().getId(),IPageConstants.CONTENT_PRODUCT);
	...
	public String configSub(long featureid, IDto dto, Account account) {
		Feature154Dto d = (Feature154Dto)dto;
	    try
		{
