...
public class Hd128ManagerImpl implements IHdFeatureManager{

	private IHd128Dao hd128Dao;
	
	public void setHd128Dao(IHd128Dao hd128Dao) {
		this.hd128Dao = hd128Dao;
	}
	...
	public HdModel findHdModel(long sitegroupid, long entityid) {
		return hd128Dao.findHdModelName(sitegroupid, entityid);
	}
