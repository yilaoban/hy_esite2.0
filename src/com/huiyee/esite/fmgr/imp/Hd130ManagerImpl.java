...
import com.huiyee.esite.fdao.IHd130Dao;
...
public class Hd130ManagerImpl implements IHdFeatureManager
{
	private IHd130Dao hd130Dao;
	...
	{
		return hd130Dao.findHdModelName(sitegroupid, entityid);
	}
	...
	public void setHd130Dao(IHd130Dao hd130Dao)
	{
		this.hd130Dao = hd130Dao;
	}
