...
import com.huiyee.esite.dto.Feature157Dto;
...
public class Feature157ManagerImpl extends AbstractFeatureManager{
	...
	public IDto config(long fid, Account account) {
		Feature157Dto dto = new Feature157Dto();
		...
		List<ContentCategory> list=hd154Dao.findCategory(account.getOwner().getId(),IPageConstants.CONTENT_VIDEO);
	...
	public String configSub(long featureid, IDto dto, Account account) {
		Feature157Dto d = (Feature157Dto)dto;
	    try
		{
