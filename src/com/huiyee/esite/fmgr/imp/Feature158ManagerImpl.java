...
import com.huiyee.esite.dto.Feature158Dto;
...
public class Feature158ManagerImpl extends AbstractFeatureManager{
	...
	public IDto config(long fid, Account account) {
		Feature158Dto dto = new Feature158Dto();
		...
		List<ContentCategory> list=hd154Dao.findCategory(account.getOwner().getId(),IPageConstants.CONTENT_FORM);
	...
	public String configSub(long featureid, IDto dto, Account account) {
		Feature158Dto d = (Feature158Dto)dto;
	    try
		{
