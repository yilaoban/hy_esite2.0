...
import com.huiyee.esite.fdao.IHd137Dao;
...
public class Hd137ManagerImpl implements IHdFeatureManager
{
	private IHd137Dao hd137Dao;
	...
	{
		return hd137Dao.findHdModelName(sitegroupid, entityid);
	}
	...
	public void setHd137Dao(IHd137Dao hd137Dao)
	{
		this.hd137Dao = hd137Dao;
	}
