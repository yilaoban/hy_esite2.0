...
public class Hd154DaoImpl extends AbstractDao implements IHd154Dao {
	...
	{
		return getJdbcTemplate().query("select * from esite.es_content_category c join esite.es_content_type t on c.typeid=t.id where  c.ownerid=? and c.status!='DEL' and c.type = ?", new Object[]
		{ id ,type}, new RowMapper()
		{
			@Override
			public Object mapRow(ResultSet rs, int arg1) throws SQLException
			{
