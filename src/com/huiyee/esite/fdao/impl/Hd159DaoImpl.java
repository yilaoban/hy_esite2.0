...
public class Hd159DaoImpl extends AbstractDao implements IHd159Dao {
	...
	{
		return getJdbcTemplate().query("select * from esite.es_content_category c where c.ownerid=? and c.status!='DEL' and c.subtype='W'", new Object[]
		{ id }, new RowMapper()
		{
			@Override
			public Object mapRow(ResultSet rs, int arg1) throws SQLException
