...
var TabbedContent = {
	...
	init2: function() {	
		$(".tabslider_141205_1 ul").bind("swipeleft",function(){
			 TabbedContent.slideContent2($(this));
		});
		
	},
	init3: function() {	
		$(".tabslider_141205_1 ul").bind("swiperight",function(){
	...
	slideContent: function(obj) {
		...
		var margin = $(obj).parent().parent().find(".slide_content_141205_1").width();
		margin = margin * ($(obj).prevAll().size() - 1);
		margin = margin * -1;
		
		
		$(obj).parent().parent().find(".tabslider_141205_1").stop().animate({
		...
		if(index == 3){
			...
			if(lid >0){
				...
				$(".tab_card_201412051107").remove();
				var html = "<ul class='tab_card_201412051107'>";
				 ...
				 html = html + "</ul>";
				 $(".tabslider_141205_1").append(html);
				})
			}
		}
	},
	slideContent2: function(obj) {
		...
		var tabs_141205_1=$(obj).parent().parent().parent().find(".tab_item");
