        ...
        _create:function() {
            ...
            (function() {
                if(me.data('itemRender')) {
                    ...
                    while(j = content[i++]) k.push('<div class="ui-slider-item" style="position:'+j.position+';"><a href="javascript:void(0)" class="loadproduct" ccid="'+j.ccid+'">' + (j.title ? '' + j.title + '': '') + '</a></div>');
                }
