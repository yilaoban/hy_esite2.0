...
<div class="wrap_content">
  ...
  <form action="/${oname}/interact/addSourceSub.action" onsubmit="return check()" class="formview">
    ...
    <dl>
      <dt>名称</dt>
      <dd>
        <input type="text" id="name" name="ofcSource.name" class="text-medium" />
    ...
    <dl>
      <dt>关联消费积分</dt>
      <dd>
        <input type="radio" name="ofcSource.type" value="1" onclick="$('.xf').show();" />
        <span>是</span>
        <input type="radio" name="ofcSource.type" value="0" onclick="$('.xf').hide();" checked="checked" />
        <span>否</span>
      </dd>
    </dl>
    <dl class="xf" style="display: none;">
      <dt>消费每满</dt>
      <dd>
        <input type="text" id="rmbjf" name="ofcSource.rmbjf" class="text-small" />
        <span>元获得1积分</span>
        <span style="color: red;">*</span>
      </dd>
    </dl>
    ...
    <dl>
      <dt>仅粉丝可签到</dt>
      <dd>
        <input type="radio" name="ofcSource.fensi" value="Y" onclick="$('.gz').show();" />
        <span>是</span>
        <input type="radio" name="ofcSource.fensi" value="N" onclick="$('.gz').hide();" checked="checked" />
        <span>否</span>
      </dd>
    </dl>
    <dl class="gz" style="display: none;">
      <dt>关注引导页链接</dt>
      <dd>
        <input type="text" id="link" name="gzEvent.link" class="text-long" />
        <span style="color: red;">*</span>
    ...
    <dl class="gz" style="display: none;">
      ...
      <dd>
        <span>标题</span>
        <input type="text" id="title" name="gzEvent.msg.title" class="text-medium" />
        <span style="color: red;">*</span>
      </dd>
      <dd>
        <span>描述</span>
        <input id="description" name="gzEvent.msg.description" class="text-long" />
        <span style="color: red;">*</span>
      </dd>
      <dd>
        <span>快照</span>
        <input type="hidden" id="pic" name="gzEvent.msg.pic_url" />
        <img id="img" src="/images/nopic.png" style="width: 100px; height: 100px; vertical-align: text-top;" />
        <span style="color: red;">*</span>
        <input type="file" id="upload" name="img" onchange="uploadPic()" value="选择图片" style="padding-left: 32px;" />
      </dd>
      <dd>
        <input type="hidden" id="url" name="gzEvent.msg.url" />
      </dd>
    </dl>
