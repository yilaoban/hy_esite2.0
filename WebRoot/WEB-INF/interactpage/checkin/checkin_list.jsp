	...
	<table width="100%" class="tb_normal" border="1" cellspacing="1"
		...
		<tbody>
			<s:iterator value="dto.list" var="s">
				<tr align="center">
					<td align="center">
						<a href="http://www.weibo.com/u/${s.ownerwbuid }" target="_blank">${s.nickName }</a>
					</td>
					...
					<td align="center">
						<a href="checkinEdit.action?ownerwbuid=${s.ownerwbuid }&mid=${mid }&utype=0">编辑</a><i class="split">|</i><!-- <a href="javascript:checkin_view(1,${s.ownerwbuid },1,'source')">预览</a><i class="split">| --><a href="checkin_data.action?ownerwbuid=${s.ownerwbuid }&mid=${mid }&utype=0">签到数据</a><i class="split">|</i><a  href="javascript:checkindel('${s.nickName }',${s.ownerwbuid },0)">删除</a>
					</td>
				</tr>
			</s:iterator>
		</tbody>
