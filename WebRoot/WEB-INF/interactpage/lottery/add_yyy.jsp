...
<div class="wrap_content left_module">
  <form action="save_yyy_sub.action?mid=${mid}" method="post" enctype="multipart/form-data" id="form1" class="formview jNice">
  	<input type="hidden" name="htype" value="Y" /> 
  	<input type="hidden" name="mid" value="10011">
	  ...
	  <a href="/${oname }/interact/index.action?mid=10011" class="return" title="返回"></a>
	</div>
	<dl>
	 	<dt>标题</dt>
		<dd>
