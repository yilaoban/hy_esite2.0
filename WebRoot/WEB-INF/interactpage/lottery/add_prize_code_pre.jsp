...
<div class="wrap_content left_module">
	<div class="toolbar pb10">
		...
		<a href="/${oname }/interact/prize.action?lid=${lid }&returnType=${returnType }&mid=${mid }" class="return" title="返回"></a>
	</div>
		<form id="addCouponsForm"  action="lottery_prize_code_upload_submit.action" name="addCouponsForm" enctype="multipart/form-data" method="post" class="formview jNice">
