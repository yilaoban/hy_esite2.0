...
<div class="wrap_content left_module">
  <form action="edit_zhuanpan_sub.action" method="post" enctype="multipart/form-data" id="form1" class="formview jNice">
  <input type="hidden" name="lid" value="${lid }"/>
  <input type="hidden" name="htype" value="Z" /> 
  <input type="hidden" name="mid" value="10003">
  <input type="hidden" name="redirectXc" value="${redirectXc }">
  <div class="toolbar pb10">
  	<ul class="c_switch">
	  <li class="selected"><a href="">编辑大转盘</a></li>
	  </ul>
	  <s:if test="redirectXc!=0">
	  	<a href="javascript:window.history.back()" class="return" title="返回"></a>
	  </s:if>
	  <s:else>
		  <a href="/${oname }/interact/index.action?mid=10003" class="return" title="返回"></a>
	  </s:else>
	</div>
	<dl>
	 	<dt>标题</dt>
	...
	<dl>
	 	<dt>开始前提示语</dt>
		<dd>
			<input type="text" class="text-long" name="startnote" value="${dto.lottery.startnote}" placeholder="大转盘活动还未开始" id="startnote"><span class="notice">提示用户该活动还没开始</span>
		</dd>
	</dl>
	<dl>
	 	<dt>结束后提示语</dt>
		<dd>
			<input type="text" class="text-long" name="endnote" value="${dto.lottery.endnote}" placeholder="大转盘活动已经结束" id="endnote"><span class="notice">提示用户该活动已结束</span>
		</dd>
	</dl>
	<dl id="ruletype">
	 	<dt>抽奖资格</dt>
	...
	<dl>
	 	<dt>活动中奖率2</dt>
		<dd>
			参与<input class="text-small" type="number" name="drawnum" type="number" name="drawnum" value="${dto.lottery.drawnum }">次抽奖必中奖.
		</dd>
	</dl>
	<dl>
	 	<dt>&nbsp;</dt>
