...
<script type="text/javascript">
	$(document).ready(function() {
		$(".c_switch li a").click(function() {
			...
			$(".c_switch li").eq(0).addClass("selected");
	...
	function zf() {
		$.ajax({
			url : "/${oname }/setting/savezfjfDesign.action",
			type : "post",
	...
	function qd() {
		$.ajax({
			url : "/${oname }/setting/saveqdjfDesign.action",
			type : "post",
	...
	function sq() {
		$.ajax({
			url : "/${oname }/setting/savesqjfDesign.action",
			type : "post",
	...
	function zs() {
		$.ajax({
			url : "/${oname }/setting/savezsjfDesign.action",
			type : "post",
	...
	function xq() {
		$.ajax({
			url : "/${oname }/setting/savexqjfDesign.action",
			type : "post",
	...
	function yy() {
		$.ajax({
			url : "/${oname }/setting/saveyyjfDesign.action",
			type : "post",
	...
	function pj() {
		$.ajax({
			url : "/${oname }/setting/savepjjfDesign.action",
			type : "post",
