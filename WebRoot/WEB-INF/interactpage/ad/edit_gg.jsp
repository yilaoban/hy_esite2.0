...
<div class="wrap_content left_module">
	<form action="/${oname }/interact/updateGG.action" id="form1" class="formview jNice" method="post">
	...
	<dl class="clearfix">
		...
		<dt>图片</dt>
		<p <s:if test="adgg.img == null">style="display: none" </s:if>>
				<img src="${adgg.img}" id="img1" height="67" width="67"/>
			</p>
		<dd>
			<div id="demo">
				<div id="as" ></div>
