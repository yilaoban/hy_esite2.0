...
<form action="/user/exam.action" method="post" id="myform" class="preview">
<ul>
<li>测评标题：${exam.title }</li>
<li>测评说明：${exam.content}</li>
<li>开始时间：<s:date name="exam.starttime" format="yyyy-MM-dd HH:mm"/></li>
<li>结束时间：<s:date name="exam.endtime" format="yyyy-MM-dd HH:mm"/></li>
<li>问题:</li>
<s:iterator value="exam.questions" var="q" status="st">
<dl>
...
<input type="hidden" name="dto.examid" value="${exam.id }"/>
