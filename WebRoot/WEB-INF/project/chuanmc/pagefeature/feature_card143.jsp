...
<div class="popup-header">
  ...
  <h4 class="modal-title" id="myModalLabel">互动模块编辑-摇一摇</h4>
  <!-- 
  <button type="button" class="btn btn-primary" onclick="newYYY()">新增</button>
   -->
</div>
<div class="popup-body">
<form enctype="multipart/form-data" method="post">
	<ul class="nav nav-tabs" role="tablist">
    <li role="presentation" class="active"><a href="#tab1" aria-controls="home" role="tab" data-toggle="tab">选择摇一摇</a></li>
    <li role="presentation"><a href="#tab2" aria-controls="profile" role="tab" data-toggle="tab">高级设置</a></li>
  </ul>

  <div class="tab-content">
    <div role="tabpanel" class="tab-pane active" id="tab1">
	    <p>请选择需要抽奖的选项：(请至微互动模块处添加摇一摇)</p>
	  <s:iterator value="dto.lotteryList" var="apt">
           <label class="block_label"><input type="radio" value="${apt.id}" name="dto.lotteryid" <s:if test="dto.lotteryid == #apt.id"> checked="checked" </s:if> /> ${apt.name} <a href="/${oname }/interact/edit_yyy.action?lid=${apt.id }&mid=10011&omid=${apt.omid }">编辑</a></label>
      </s:iterator>
    </div>
