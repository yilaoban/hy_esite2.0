...
<script type="text/javascript">
		        ...
		        series:  eval(ordlist)
	              ...
	              new Highcharts.Chart({  
	                ...
	                series: [{
	                  type: 'pie',
	                  name: '人数',
	                  data: dataobj[i].optionDto.researchdata
	                }]
	              });  
	            }
              }
  ...
  <div class="toolbar pb10">
  	<ul class="c_switch">
	  <li ><a href="/${oname }/interact/research_record_list.action?searchid=${searchid}&mid=${mid }&mtype=0">微博数据</a></li>
	  <li ><a href="/${oname }/interact/research_record_list.action?searchid=${searchid}&mid=${mid }&mtype=1">微信数据</a></li>
	  <li ><a href="/${oname }/interact/research_record_list.action?searchid=${searchid}&mid=${mid }&mtype=2">用户数据</a></li>
	  <li ><a href="/${oname }/interact/research_record_list.action?searchid=${searchid}&mid=${mid }&mtype=-1">匿名数据</a></li>
	  <li class="selected"><a href="/${oname }/interact/research_record_data.action?searchid=${searchid}&mid=${mid }">调研结果</a></li>
	  </ul>
