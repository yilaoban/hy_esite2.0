...
function delMedia(id,name){
		var layerid=layer.confirm('确定将['+name+']删除吗?',{title:"确认删除"},function(){
			$.post("/${oname}/interact/delMedia.action",{inajax:1,mid:id},function(data){
			if(data==0){
...
<div class="wrap_content">
	<div class="toolbar pb10">
		<a href="/${oname }/interact/addMedia.action" class="btn btn-primary">新增媒体</a>
	</div>
	...
	<table width="100%" class="tb_normal" border="1" cellspacing="1"
		...
		<s:iterator value="dto.adMediaList" var="a" status="st">
			<tr>
				...
				<td>
					<a href="/${oname }/interact/editMedia.action?mid=${a.id}">编辑</a>
					<a href="/${oname}/interact/mediaWay.action?mid=${a.id}">详情</a>
