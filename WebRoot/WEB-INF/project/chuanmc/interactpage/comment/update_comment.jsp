...
<div class="wrap_content left_module">
  ...
  <div class="toolbar pb10">
 	...
 	<dl>
	 	<dt>标题</dt>
		<dd>
			<input type="text" class="text-medium" name="comment.name" id="title" onblur="checkTitle()"  value="${dto.comment.name }">
	...
	<dl>
	 	<dt>是否需要审核</dt>
		<dd>
			<s:if test='dto.comment.needcheck=="Y"'>
				<label class="forradio"><input type="radio"  name="comment.needcheck"  value="Y" checked="checked">是</label>
				<label class="forradio"><input type="radio"  name="comment.needcheck"  value="N" >否</label>
			</s:if>
			<s:else>
