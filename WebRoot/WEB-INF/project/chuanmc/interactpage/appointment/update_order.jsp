...
<div class="wrap_content left_module">
  <form action="update_order_save.action" method="post" id="myform" name="myform" enctype="multipart/form-data" class="formview jNice">
  <input type="hidden" name="id" value="${id}">
  <input type="hidden" name="apt.id" value="${id}">
  <input type="hidden" name="redirectCb" value="${redirectCb}">
  <div class="toolbar pb10">
 	...
 	<dl>
	 	<dt>标题</dt>
		<dd>
			<input type="text" class="text-medium" name="apt.title" value="${dto.am.title }" id="title" onblur="checkTitle()">
	...
	<dl>
	 	<dt>简介</dt>
		<dd>
			<textarea  maxlength="200" name="apt.content" >${dto.am.content }</textarea>
 	...
 	<dl>
	 	<dt>开始时间</dt>
		<dd>
			<input type="text" id="start" name="apt.starttime" onblur="checkTitle2()" onfocus="WdatePicker({maxDate:'#F{$dp.$D(\'end\')}',dateFmt:'yyyy-MM-dd HH:mm:ss'})" class="Wdate" onblur="checkSdate()" value="<s:date name="dto.am.starttime" format="yyyy-MM-dd HH:mm:ss"/>" ><span class="must">*</span><span id="start_"></span>
		</dd>
	</dl>
	<dl>
	 	<dt>结束时间</dt>
		<dd>
			<input type="text" id="end" name="apt.endtime" onblur="checkTitle3()" onfocus="WdatePicker({minDate:'#F{$dp.$D(\'start\')}',dateFmt:'yyyy-MM-dd HH:mm:ss'})" class="Wdate"  onblur="checkEdate()" value="<s:date name="dto.am.endtime" format="yyyy-MM-dd HH:mm:ss"/>" ><span class="must">*</span><span id="end_"></span>
		</dd>
	</dl>
	<dl>
	 	<dt>开始前提示语</dt>
		<dd>
			<input type="text" class="text-long" name="apt.startnote" value="${dto.am.startnote}" placeholder="活动还未开始" id="startnote"><span class="notice">提示用户该活动还没开始</span>
		</dd>
	</dl>
	<dl>
	 	<dt>结束后提示语</dt>
		<dd>
			<input type="text" class="text-long" name="apt.endnote" value="${dto.am.endnote}" placeholder="活动已经结束" id="endnote"><span class="notice">提示用户该活动已结束</span>
		</dd>
	</dl>
	<dl>
	 	<dt>活动上限</dt>
		<dd>
			<input type="text" class="text-small" name="apt.totallimit" value="${dto.am.totallimit}" onkeyup="this.value=this.value.replace(/\D/g,'')"  onafterpaste="this.value=this.value.replace(/\D/g,'')">次/人
	...
	<dl>
	 	<dt>每日活动上限</dt>
		<dd>
			<input type="text" class="text-small" name="apt.daylimit" value="${dto.am.daylimit}" onkeyup="this.value=this.value.replace(/\D/g,'')"  onafterpaste="this.value=this.value.replace(/\D/g,'')">次/人
			<span class="notice"></span>
		</dd>
	</dl>
	<dl>
	 	<dt>活动后关联到抽奖</dt>
		<dd>
 			<label class="forradio"><input type="radio" name="apt.islottery" value="Y" <s:if test='dto.am.islottery == "Y"'> checked="checked" </s:if> onclick="$('.type').show()"/>是</label>
			<label class="forradio"><input type="radio" name="apt.islottery" value="N" <s:if test='dto.am.islottery == "N"'> checked="checked" </s:if> onclick="$('.type').hide()"/>否</label>
		</dd>
	</dl>
	<dl class="type" <s:if test='dto.am.islottery == "N"'>style="display: none"</s:if>>
		<dt>抽奖方式</dt>
		<dd>
		...
		<dd id="Z" <s:if test='dto.type != "Z"'> style="display: none" </s:if>>
			<select name="dto.zlotteryid" class="dis" id="zlotteryid">
				...
				<s:iterator value="zlotteryList" var="f">
				  <option value ="${f.id  }" <s:if test='dto.am.lotteryid == #f.id'>selected="selected" </s:if>>${f.name }</option>
				</s:iterator>  
			</select>
		</dd>
	...
	<dl class="type" <s:if test='dto.am.islottery == "N"'>style="display: none"</s:if>>
	 	<dt>活动增加抽奖机会</dt>
		<dd>
			<input type="text" class="text-small" name="apt.lotterychance" value="${dto.am.lotterychance }" id="lotterychance">次/人
	...
	<dl class="type" <s:if test='dto.am.islottery == "N"'>style="display: none"</s:if>>
	 	<dt>增加抽奖机会上限</dt>
		<dd>
			<input type="text" class="text-small" name="apt.maxlotterychance" value="${dto.am.maxlotterychance }" onkeyup="this.value=this.value.replace(/\D/g,'')"  onafterpaste="this.value=this.value.replace(/\D/g,'')">次/人
			<span class="notice">（0表示不增加）</span>
		</dd>
	</dl>
	<dl>
	 	<dt>活动后赠送积分</dt>
		<dd>
			<input type="text" class="text-small" name="apt.balance" value="${dto.am.balance }" onkeyup="this.value=this.value.replace(/\D/g,'')"  onafterpaste="this.value=this.value.replace(/\D/g,'')">积分/人
	...
	<tbody>
		<tr align="center" >
			 <td >
			 	固定字段
			 	<s:set name="mp" value="dto.am.mappingMap['姓名']"></s:set>
		...
		<tr align="center" >
			 <td >
			 	固定字段
			 	<s:set name="mp" value="dto.am.mappingMap['年龄']"></s:set>
		...
		<tr align="center" >
			<td align="center">
				固定字段
				<s:set name="mp" value="dto.am.mappingMap['性别']"></s:set>
		...
		<tr align="center" >
			 <td align="center">
			 	固定字段
			 	<s:set name="mp" value="dto.am.mappingMap['生日']"></s:set>
		...
		<tr align="center" >
			 <td align="center">
			 	固定字段
			 	<s:set name="mp" value="dto.am.mappingMap['省份']"></s:set>
		...
		<tr align="center" >
			<td align="center">
			 	固定字段
			 	<s:set name="mp" value="dto.am.mappingMap['城市']"></s:set>
		...
		<tr align="center" >
			<td align="center">
			 	固定字段
			 	<s:set name="mp" value="dto.am.mappingMap['区域']"></s:set>
		...
		<tr align="center" >
			<td align="center">
			 	固定字段
			 	<s:set name="mp" value="dto.am.mappingMap['详细地址']"></s:set>
		...
		<tr align="center" >
			<td align="center">
			 	固定字段
			 	<s:set name="mp" value="dto.am.mappingMap['身份证']"></s:set>
		...
		<tr align="center" >
			<td align="center">
			 	固定字段
			 	<s:set name="mp" value="dto.am.mappingMap['邮箱']"></s:set>
		...
		<tr align="center" >
			<td align="center">
			 	固定字段
			 	<s:set name="mp" value="dto.am.mappingMap['手机']"></s:set>
		...
		<tr align="center" >
			<td align="center">
			 	固定字段
			 	<s:set name="mp" value="dto.am.mappingMap['日期']"></s:set>
		...
		<tr align="center" >
			<td align="center">
				固定字段
				<s:set name="mp" value="dto.am.mappingMap['验证码']"></s:set>
	...
	<tbody id="templeteTBody">
			<s:iterator  value="dto.am.udfList" var="a"  status = "st">
					<s:if test='tag=="N"'>
