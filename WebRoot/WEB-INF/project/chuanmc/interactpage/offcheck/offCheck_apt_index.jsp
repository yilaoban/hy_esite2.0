...
<script type="text/javascript">
		function checkAptForm(){
			$.ajax({
		        cache: true,
		        type: "POST",
		        url:"/${oname }/interact/ajaxAptSub.action",
...
<div class="wrap_content left_module">
  <form action="" method="post" id="myform" name="myform" enctype="multipart/form-data" class="formview jNice">
  	<input type="hidden" name="apt.id"  value="${storeCrm.apt.id }"/>
  	<input type="hidden" name="apt.title"  value="${storeCrm.apt.title }"/>
	...
	<tbody>
		<tr align="center" >
			 <td >
			 	固定字段
			 	<s:set name="mp" value="storeCrm.apt.mappingMap['姓名']"></s:set>
		...
		<tr align="center" >
			 <td >
			 	固定字段
			 	<s:set name="mp" value="storeCrm.apt.mappingMap['年龄']"></s:set>
		...
		<tr align="center" >
			<td align="center">
				固定字段
				<s:set name="mp" value="storeCrm.apt.mappingMap['性别']"></s:set>
		...
		<tr align="center" >
			 <td align="center">
			 	固定字段
			 	<s:set name="mp" value="storeCrm.apt.mappingMap['生日']"></s:set>
		...
		<tr align="center" >
			 <td align="center">
			 	固定字段
			 	<s:set name="mp" value="storeCrm.apt.mappingMap['省份']"></s:set>
		...
		<tr align="center" >
			<td align="center">
			 	固定字段
			 	<s:set name="mp" value="storeCrm.apt.mappingMap['城市']"></s:set>
		...
		<tr align="center" >
			<td align="center">
			 	固定字段
			 	<s:set name="mp" value="storeCrm.apt.mappingMap['区域']"></s:set>
		...
		<tr align="center" >
			<td align="center">
			 	固定字段
			 	<s:set name="mp" value="storeCrm.apt.mappingMap['详细地址']"></s:set>
		...
		<tr align="center" >
			<td align="center">
			 	固定字段
			 	<s:set name="mp" value="storeCrm.apt.mappingMap['身份证']"></s:set>
		...
		<tr align="center" >
			<td align="center">
			 	固定字段
			 	<s:set name="mp" value="storeCrm.apt.mappingMap['邮箱']"></s:set>
		...
		<tr align="center" >
			<td align="center">
			 	固定字段
			 	<s:set name="mp" value="storeCrm.apt.mappingMap['手机']"></s:set>
		...
		<tr align="center" >
			<td align="center">
			 	固定字段
			 	<s:set name="mp" value="storeCrm.apt.mappingMap['日期']"></s:set>
		...
		<tr align="center" >
			<td align="center">
				固定字段
				<s:set name="mp" value="storeCrm.apt.mappingMap['验证码']"></s:set>
	...
	<tbody id="templeteTBody">
			<s:iterator  value="storeCrm.apt.udfList" var="a"  status = "st">
					<s:if test='tag=="N"'>
