...
<div class="wrap_content left_module">
	<div class="toolbar pb10">
		<ul class="c_switch">
			<li class="selected"><a href="/${oname }/interact/findPrizeCodePre.action?id=${id}&lid=${lid }&returnType=${returnType}&mid=${mid }">券号信息</a></li>
		</ul>
		<form action="/${oname }/interact/findPrizeCode.action" style="float: left" method="post">
		...
		<a href="/${oname }/interact/prize.action?lid=${lid }&returnType=${returnType }&mid=${mid }" class="return" title="返回"></a></div>
