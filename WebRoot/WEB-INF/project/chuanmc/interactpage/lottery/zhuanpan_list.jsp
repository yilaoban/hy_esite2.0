...
<div class="toolbar pb10">
  ...
  <a href="/${oname }/interact/save_zhuanpan.action?mid=${mid }" class="btn btn-primary">新增转盘</a>
</div>
		...
		<tbody>
			<s:iterator value="dto.list" var="s">
				<tr align="center">
					...
					<td align="center">
						<a href="edit_zhuanpan.action?lid=${s.id }&mid=${mid }">编辑</a><i class="split">|</i><!-- <a href="javascript:lottery_view(${s.id },10000,'source',7)">预览</a><i class="split">|</i> -->
