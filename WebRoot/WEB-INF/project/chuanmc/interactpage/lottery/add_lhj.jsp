...
<div class="wrap_content left_module">
  <form action="save_lhj_sub.action" method="post" enctype="multipart/form-data" id="form1" class="formview jNice">
  	<input type="hidden" name="htype" value="L" />
  	<input type="hidden" name="mid" value="10004">
  	<div class="toolbar pb10">
  	  <ul class="c_switch">
	  <li class="selected"><a href="">新增砸金蛋</a></li>
	  </ul>
	  <img src="/images/help.jpg" height="20" width="20" onclick="help_zjd()" title="帮助文档" style="cursor:pointer">
	  <a href="/${oname }/interact/index.action?mid=10004" class="return" title="返回"></a>
	</div>
	<dl>
	 	<dt>标题</dt>
		<dd>
	...
	<dl>
	 	<dt>开始前提示语</dt>
		<dd>
			<input type="text" class="text-long" name="startnote" placeholder="砸金蛋活动还未开始" id="startnote"><span class="notice">提示用户该活动还没开始</span>
		</dd>
	</dl>
	<dl>
	 	<dt>结束后提示语</dt>
		<dd>
			<input type="text" class="text-long" name="endnote" placeholder="砸金蛋活动已经结束" id="endnote"><span class="notice">提示用户该活动已结束</span>
		</dd>
	</dl>
	<dl id="ruletype">
	 	<dt>抽奖资格</dt>
	...
	<dl style="display: none">
		...
		<dd>
		 ...
		 --%>
		<dd>
			<label class="forradio"><input type="checkbox" name="wxg" checked="checked" value="1" >微信粉丝</label>
		</dd>
	</dl>
	<dl>
	 	<dt>抽奖机会</dt>
