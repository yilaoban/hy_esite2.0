...
<div class="wrap_content left_module">
	...
	<tbody>
		<s:iterator value="dto.inviteRecordList" var="s">
			<tr align="center" >
				...
				<td>是</td>		
				<td><s:if test='#s.checked=="Y"'>是</s:if><s:else>否</s:else></td>
				<td><s:if test="dto.relationMap[#s.id]!=null"><a href="javascript:showAptDetail('${oname }','${dto.relationMap[s.id] }')">查看详情</a></s:if></td>		
			</tr>
		</s:iterator>
	</tbody>
	</table>
