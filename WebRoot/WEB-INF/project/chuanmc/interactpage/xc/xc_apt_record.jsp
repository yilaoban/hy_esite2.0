...
<div class="wrap_content left_module">
  <div class="toolbar pb10">
  	<ul class="c_switch">
	  <li <s:if test="data_select==0">class="selected"</s:if>><a href="xcAptRecord.action?aptid=${aptid }&data_select=0">微博数据</a></li>
	  <li <s:if test="data_select==1">class="selected"</s:if>><a href="xcAptRecord.action?aptid=${aptid }&data_select=1">微信数据</a></li>
	  <li <s:if test="data_select==2">class="selected"</s:if>><a href="xcAptRecord.action?aptid=${aptid }&data_select=2">用户数据</a></li>
	  <li <s:if test="data_select==-1">class="selected"</s:if>><a href="xcAptRecord.action?aptid=${aptid }&data_select=-1">匿名数据</a></li>
	  </ul>
