...
<div class="wrap_content left_module">
	  <div class="toolbar pb10">
	  	<ul class="c_switch">
		  <li class="selected"><a href="/${oname }/interact/index.action?mid=10009">微博数据</a></li>
		  </ul>
		...
		<tbody>
			<s:iterator value="dto.list" var="s">
				<tr>
					...
					<td>${s.used }</td>
					<td><a href="javascript:void(0);" onclick="jifenDetail(${ownerwbuid },'${s.wbuid }','${mid }')">详情</a></td>
				</tr>
				</s:iterator>
		</tbody>
	</table>
