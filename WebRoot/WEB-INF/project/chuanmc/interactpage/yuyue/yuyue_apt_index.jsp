...
<div class="wrap_content left_module">
  <form action="" method="post" id="myform" name="myform" enctype="multipart/form-data" class="formview jNice">
  	<input type="hidden" name="apt.id"  value="${yuYue.apt.id }"/>
  	<input type="hidden" name="apt.title"  value="${yuYue.apt.title }"/>
	...
	<tbody>
		<tr align="center" >
			 <td >
			 	固定字段
			 	<s:set name="mp" value="yuYue.apt.mappingMap['姓名']"></s:set>
		...
		<tr align="center" >
			 <td >
			 	固定字段
			 	<s:set name="mp" value="yuYue.apt.mappingMap['年龄']"></s:set>
		...
		<tr align="center" >
			<td align="center">
				固定字段
				<s:set name="mp" value="yuYue.apt.mappingMap['性别']"></s:set>
		...
		<tr align="center" >
			 <td align="center">
			 	固定字段
			 	<s:set name="mp" value="yuYue.apt.mappingMap['生日']"></s:set>
		...
		<tr align="center" >
			 <td align="center">
			 	固定字段
			 	<s:set name="mp" value="yuYue.apt.mappingMap['省份']"></s:set>
		...
		<tr align="center" >
			<td align="center">
			 	固定字段
			 	<s:set name="mp" value="yuYue.apt.mappingMap['城市']"></s:set>
		...
		<tr align="center" >
			<td align="center">
			 	固定字段
			 	<s:set name="mp" value="yuYue.apt.mappingMap['区域']"></s:set>
		...
		<tr align="center" >
			<td align="center">
			 	固定字段
			 	<s:set name="mp" value="yuYue.apt.mappingMap['详细地址']"></s:set>
		...
		<tr align="center" >
			<td align="center">
			 	固定字段
			 	<s:set name="mp" value="yuYue.apt.mappingMap['身份证']"></s:set>
		...
		<tr align="center" >
			<td align="center">
			 	固定字段
			 	<s:set name="mp" value="yuYue.apt.mappingMap['邮箱']"></s:set>
		...
		<tr align="center" >
			<td align="center">
			 	固定字段
			 	<s:set name="mp" value="yuYue.apt.mappingMap['手机']"></s:set>
		...
		<tr align="center" >
			<td align="center">
			 	固定字段
			 	<s:set name="mp" value="yuYue.apt.mappingMap['日期']"></s:set>
		...
		<tr align="center" >
			<td align="center">
				固定字段
				<s:set name="mp" value="yuYue.apt.mappingMap['验证码']"></s:set>
	...
	<tbody id="templeteTBody">
			<s:iterator  value="yuYue.apt.udfList" var="a"  status = "st">
					<s:if test='tag=="N"'>
