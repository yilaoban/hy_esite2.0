...
<div class="iframe_body">
	<form action="updateStatus.action" id="form" method="post">
		<input type="hidden" value="${id }" name="id">
		<input type="radio" name="status" value="CMP" checked="checked">审核成功
		<input type="radio" name="status" value="FLD">审核失败
