				...
				<s:iterator value="pdto.wxPageShowlist" var="p" status="st"> 
					<div class="towxcontent">
						...
						<div class="towxcontentbutton">
							...
							<span style="float:right;margin-right:20px;"><a href="javascript:void(0);" onclick="editWxShare(${p.id},${siteid},'${oname}')" class="button">修改</a> <a href="javascript:void(0);" onclick="deleteWxShare(${p.id},${siteid},'${p.title }','${oname }')" class="button">删除</a></span>
						</div>
					</div>
