...
<div class="switch_tab_div pb10">
		...
		<s:if test='dto.sitegroup.stype=="W"'>
			<span><a href="/${oname}/page/website.action">微网站列表</a><i class="gt">&gt;&gt;</i> ${dto.site.name }</span>
		</s:if>
...
<div class="toolbar pb10">
   <input value="创建页面" type="button" class="addButton" onclick="create_page(${dto.site.id})"/>
   <input value="上传整站" type="button" class="addButton" onclick="upload_page_html(${dto.site.id})" />
   <s:if test='dto.site.upWhole == "Y"'>
   <div class="btn-group">
   	<button type="button" class="addButton dropdown-toggle" data-toggle="dropdown" >整站资源<span class="caret"></span></button>
	   ...
	   <input value="整站同步" type="button" class="addButton" onclick="upwhole('${sessionScope.account.owner.entity }',${dto.site.id})" />
   	   <%-- <input value="恢复备份" type="button" onclick="beifen('${sessionScope.account.owner.entity }',${dto.site.id})" />--%>
   </s:if>
 	<div class="btn-group">
   	<button type="button" class="addButton dropdown-toggle" data-toggle="dropdown" >一键操作<span class="caret"></span></button>
   	 <ul class="dropdown-menu">
	...
	<div class="btn-group">
	  <button type="button" class="addButton dropdown-toggle" data-toggle="dropdown" >超级用户特权<span class="caret"></span></button>
	  <ul class="dropdown-menu">
