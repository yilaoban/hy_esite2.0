...
<div class="wrap_content left_module">
  <form action="csAddSub.action" method="post" enctype="multipart/form-data" id="form1" class="formview jNice">
  <input type="hidden" name="mid" value="10013">
  <div class="toolbar pb10">
  	<ul class="c_switch">
	  <li class="selected"><a href="">新增传播</a></li>
	  </ul>
 	...
 	<dl>
	 	<dt>标题</dt>
		<dd>
			<input type="text" class="text-medium" autocomplete="off" placeholder="此标题仅方便您记忆，请任意填写" id="addname" name="title" value="${title }" onblur="nameonblur()"/>
	...
	<dl>
	 	<dt>开始前提示语</dt>
		<dd>
			<input type="text" class="text-long" autocomplete="off" name="startNote"><span class="notice">提示用户该活动还没开始</span>
		</dd>
	</dl>
	<dl>
	 	<dt>结束后提示语</dt>
		<dd>
			<input type="text" class="text-long" autocomplete="off" name="endNote"><span class="notice">提示用户该活动已结束</span>
		</dd>
	</dl>
	<dl>
	 	<dt>传播类型</dt>
