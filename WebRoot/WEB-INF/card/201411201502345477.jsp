...
<!-- 微申请2 -->
<link rel="stylesheet" href="/css/hudong/shenqing4/index.css" type="text/css"></link>
<%@include file="/WEB-INF/card/background.jsp"%>
	<s:if test='blocks[0].display=="Y"'>
	<div class="shenqing_141120_c clearfix block ${blocks[0].ctname}" status="0" hyct="Y" style="${blocks[0].hyct}" hyblk="I" hydata="${blocks[0].rid}" class_data="hy2015050741526">
					...
					<s:if test='#p.isshow == "Y"'>
						...
						<label class="control-label" >${p.name }</label>
							<div class="controls" >
								...
								<div style="margin:0" id="picker${p.mapping}">选择图片</div>
	...
	<form action="" method="get">
		...
		<div class="control-form">
	     ...
	     <div class="controls">
	        ...
	        <input name="" type="radio" value=""/>邮件营销系
	     </div>
		</div>
		<div class="control-form">
