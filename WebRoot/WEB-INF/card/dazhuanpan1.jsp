...
<div class="turntable-bg block ${blocks[1].ctname}" status="0" hyct="Y" style="${blocks[1].hyct}" hydata="${blocks[1].rid}">
	<s:if test='blocks[1].obj.id > 0'> 
		<div class="pointer"><img src="/images/hudong/dazhuanpan1/dzp_simg.png" alt="pointer" width=100% height=100% /></div>
		<div class="rotate" ><img id="rotate" src="/images/hudong/dazhuanpan1/dzp_bimg.png" alt="turntable" width=100% height=100% /></div>
		<s:set name="obj" value="blocks[1].obj" />
	</s:if>
	<s:else>
		<img src="/images/hudong/dazhuanpan1/dzp_03.png" width="auto\9" height="auto" style="max-width: 100%;" hyvar="img" hydesc="320*210"/>
	</s:else>
</div>
</s:if>
