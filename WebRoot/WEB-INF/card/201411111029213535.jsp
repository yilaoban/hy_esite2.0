...
<!-- 图片列表3 -->
<link href="/css/liebiao/16/list.css" rel="stylesheet" type="text/css" />
	...
	<ul class_data="hy2015050728835">
		<s:if test='blocks[1].list.size == 0'>
			<li class_data="hy2015050728911"><a href="#" target="_blank" hyvar="link">
		       <div class="liebiao_141110_1_b_img" class_data="hy2015050728326"><img src="/images/liebiao/16/tu1.jpg" width="100%" height="100%" hyvar="img" hydesc="200*200"/></div>
		     ...
		     <li class_data="hy2015050728570"><a href="#" target="_blank" hyvar="link">
		       <div class="liebiao_141110_1_b_img" class_data="hy2015050728621"><img src="/images/liebiao/16/tu2.jpg" width="auto\9" height="auto" style="max-width: 100%;" hyvar="img" hydesc="200*200"/></div>
		     ...
		     <li class_data="hy2015050728214"><a href="#" target="_blank" hyvar="link">
		       <div class="liebiao_141110_1_b_img" class_data="hy2015050728746"><img src="/images/liebiao/16/tu3.jpg" width="auto\9" height="auto" style="max-width: 100%;" hyvar="img" hydesc="200*200"/></div>
	    ...
	    <s:else>
			<s:iterator status='st' value='blocks[1].list' var='item'>
				<li class_data="hy2015050728759">
			       <div class="liebiao_141110_1_b_img" class_data="hy2015050728793"><img src="${imgDomain}${item.imgurl}" width="125" style="max-width: 100%;" hyvar="img" hydesc="200*200"/></div>
			       <span class="liebiao_141110_1_b_tiaoti" hyvar="name" class_data="hy2015050728763">${item.title}</span>
			       <span class="liebiao_141110_1_b_j" hyvar="desc" class_data="hy2015050728154">${item.tag}</span> 
			     </li>
		     </s:iterator>
	    </s:else>
	</ul>
