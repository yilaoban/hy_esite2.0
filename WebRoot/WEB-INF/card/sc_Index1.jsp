...
<div class="more">
	<%-- 
        <a href="/${oname}/user/payProductList.action">查看所有商品<img src="/images/scIndex/right2.png"></a>
        --%>
</div>
...
<div class="bottom2">
	<p>
		<a href="/${oname}/user/payHome.action" class="shouye2">首页</a>
		<a href="/${oname}/user/payProductList.action" class="fenlei">分类</a>
		...
		$.post("/${oname}/user/loadcontent.action",{"ccid":ccid,"pageId":1,"size":6},function(data){
			$.each(data.product,function(index,value){
				...
				if(value.vip>0){
				    ...
				    html +=		'<a href="'+linkurl+'">';
				    html +=		'<img src="'+imgurl+'">';
					html +=    	'<p>￥'+value.salesprice+'元<i>￥'+value.price+'元</i></p>';
