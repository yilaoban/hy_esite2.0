...
<link href="/css/shop/myorders2.css" rel="stylesheet" type="text/css">
 ...
 function checkTel(){
	var re=/^(13[0-9]|14[5|7]|15[0|1|2|3|5|6|7|8|9]|18[0|1|2|3|5|6|7|8|9]|17[0|1|2|3|5|6|7|8|9])\d{8}$/;
...
<div class="add">
    ...
    <li><input type="tel" placeholder="手机号码" id="telphone" value="${dto.address.telphone}"></li>
    <li>
