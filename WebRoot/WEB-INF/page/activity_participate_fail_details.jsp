...
<div class="frame_content">
	<form action="/page/activity_participate_fail_details.action" method="post" id="findForm">
	...
	<form action="/page/activity_participate_fail_details_by_nickname.action" method="post" id="seek">
