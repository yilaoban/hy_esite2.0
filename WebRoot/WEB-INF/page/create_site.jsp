...
<form id="site_form" <s:if test ="siteid == 0">action="/page/site_create_sub.action"</s:if><s:else> action="/page/site_update_sub.action"</s:else> method="post" class="jNice">
	<p id="sitename">名称：<input type="text" id="site_name" name="sitename" class="text-medium" value="${sitename }" /></p>
	<s:if test="siteid == 0">
